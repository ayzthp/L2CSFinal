...
echo "🚀 Setting up Desktop Camera 8 L2CS Gaze Tracking Environment..."
echo "="*60
...
python3 -m venv desktop_l2cs_env
...
# Test camera 8 specifically
cap = cv2.VideoCapture(8)
if cap.isOpened():
    print('✅ Camera 8: Available for desktop use')
    cap.release()
else:
    print('⚠️  Camera 8: Not available (you may need to connect an external camera)')
...
echo ""
echo "🎯 To run the desktop camera 8 gaze tracker:"
echo "   source desktop_l2cs_env/bin/activate"
echo "   ./desktop_run.sh"
echo ""
