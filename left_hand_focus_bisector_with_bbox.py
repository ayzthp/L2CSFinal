...
class LeftHandFocusBisectorWithBBox:
    def __init__(self, save_dir="captures", camera_id=8):
        ...
        print("✅ Left Hand Focus Bisector Tracker with Bounding Box initialized!")
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                cv2.imshow('Left Hand Focus Bisector Tracker with Bounding Box', frame)
                ...
                if k==ord('s'):
                    ...
                    fn = f"left_bisector_bbox_{st}_{al}_{left}_{ts}.jpg"
